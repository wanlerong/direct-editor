...
export class UndoManager {
  ...
  private executeOperation(sourceStack: DeltaItem[], targetStack: DeltaItem[]): void {
  ...
  undo(): void {
    this.executeOperation(this.undoStack, this.redoStack);
  }

  redo(): void {
    this.executeOperation(this.redoStack, this.undoStack);
  }
}